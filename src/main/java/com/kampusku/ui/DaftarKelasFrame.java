 ...
 * @author ACER
 */
public class DaftarKelasFrame extends javax.swing.JFrame {

    /**
     * Creates new form DashboardFrame
     */
    public DaftarKelasFrame() {
        initComponents();
    ...
    private void initComponents() {
        ...
        navDaftarKelas.setForeground(new java.awt.Color(255, 255, 255));
        ...
        labelNamaKelas.setFont(new java.awt.Font("Poppins Medium", 0, 14)); // NOI18N
        labelNamaKelas.setForeground(new java.awt.Color(51, 51, 51));
        labelNamaKelas.setText("Kode Kelas");
        ...
        btnTambah.setText("Tambah Kelas");
                ...
                .addGroup(mainLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(mainLayout.createSequentialGroup()
                        ...
                        .addGroup(mainLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(kodeKelasField, javax.swing.GroupLayout.PREFERRED_SIZE, 181, javax.swing.GroupLayout.PREFERRED_SIZE))))
                .addGap(42, 42, 42))
        );
            ...
            .addGroup(mainLayout.createSequentialGroup()
                ...
                .addGroup(mainLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(mainLayout.createSequentialGroup()
                        ...
                        .addComponent(jOptionPane, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(12, 12, 12)
                .addComponent(labelNamaKelas, javax.swing.GroupLayout.PREFERRED_SIZE, 12, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void loadDataKelas() {
        ...
        updateTableData(kelasList);
    }

    private void handleSearch() {
        String keyword = searchField.getText();
        List<Kelas> results = getKelasByNama(keyword);
    ...
    private void updateTableData(List<Kelas> kelasList) {
    ...
    private List<Kelas> getKelasByNama(String namaKelas) {
        KelasDAO kelasDAO = new KelasDAO();
        return kelasDAO.getAllKelasByNama(namaKelas);
    }
    ...
    private void btnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHapusActionPerformed
        ...
        String namaKelas = kodeKelasField.getText().trim();

        // Mengecek apakah ada field yang kosong
        if (namaKelas.isEmpty()) {
            // Menampilkan pesan error jika ada field yang kosong
            jOptionPane.showMessageDialog(null, "Nama Kelas harus diisi!", "Error", jOptionPane.ERROR_MESSAGE);
    ...
    private void btnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditActionPerformed
        ...
        if (kodeKelas.isEmpty()) {
            ...
            new EditDataKelasFrame(kodeKelasInt).setVisible(true);
            dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DaftarKelasFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

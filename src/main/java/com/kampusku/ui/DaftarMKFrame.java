 ...
 * @author ACER
 */
public class DaftarMKFrame extends javax.swing.JFrame {

    /**
     * Creates new form DashboardFrame
     */
    public DaftarMKFrame() {
        initComponents();
    ...
    private void initComponents() {
        ...
        navDaftarMK.setForeground(new java.awt.Color(255, 255, 255));
        ...
        jScrollPane2.setViewportView(tableMK);
        ...
        btnHapus.setText("Hapus MataKuliah");
        ...
        btnEdit.setText("Edit MataKuliah");
        ...
        btnTambah.setText("Tambah MataKuliah");
        ...
        cmbSks.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "2", "3", "4" }));
        ...
        mainLayout.setHorizontalGroup(
            ...
            .addGroup(mainLayout.createSequentialGroup()
                .addGroup(mainLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(mainLayout.createSequentialGroup()
                        .addGap(30, 30, 30)
                        .addComponent(kodeMKField, javax.swing.GroupLayout.PREFERRED_SIZE, 181, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(mainLayout.createSequentialGroup()
                        .addGap(30, 30, 30)
            ...
            .addGroup(mainLayout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(cmbSks, javax.swing.GroupLayout.PREFERRED_SIZE, 41, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(98, 98, 98))
        );
            ...
            .addGroup(mainLayout.createSequentialGroup()
                ...
                .addGroup(mainLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(mainLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(btnSearch)
                        .addComponent(cmbSks, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(jLabel4)))
                .addGap(12, 12, 12)
                .addGroup(mainLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void loadDataJadwal() {
        ...
        List<MataKuliah> mataKuliahList = mataKuliahDAO.getAllMK();
        // Memuat data ke tabel
        updateTableData(mataKuliahList);
    }

    private void handleSearch() {
        String keyword = searchField.getText();

        // Panggil metode pencarian dengan parameter keyword
        List<MataKuliah> results = getMKByNama(keyword);
    ...
    private void updateTableData(List<MataKuliah> mataKuliahList) {
        // Mendapatkan model tabel
        DefaultTableModel model = (DefaultTableModel) tableMK.getModel();
...
// Metode pencarian berdasarkan nama mata kuliah
    private List<MataKuliah> getMKByNama(String namaMK) {
        MataKuliahDAO mataKuliahDAO = new MataKuliahDAO();
        return mataKuliahDAO.getAllMKByNama(namaMK);
    }

    // Metode pencarian jadwal berdasarkan jumlah SKS
    private List<MataKuliah> getMKBySks(int sks) {
        MataKuliahDAO mataKuliahDAO = new MataKuliahDAO();
        return mataKuliahDAO.getAllMKBySks(sks);
    }
    
    private void handleComboBoxSelection() {
        String selectedSks = (String) cmbSks.getSelectedItem();

        int sks = Integer.parseInt(selectedSks);

        List<MataKuliah> results = getMKBySks(sks);
    ...
    private void btnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHapusActionPerformed
        ...
        if (kodeMK.isEmpty()) {
            ...
            MataKuliahDAO mataKuliahDAO = new MataKuliahDAO();
            if(mataKuliahDAO.deleteMataKuliah(kodeMKInt)){
    ...
    private void btnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditActionPerformed
        ...
        if (kodeMK.isEmpty()) {
            ...
            int kodeMKInt = Integer.parseInt(kodeMK);
            new EditDataMKFrame(kodeMKInt).setVisible(true);
            dispose();
        }
    ...
    private void btnTambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTambahActionPerformed
        // TODO add your handling code here:
        new AddDataMKFrame().setVisible(true);
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DaftarMKFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

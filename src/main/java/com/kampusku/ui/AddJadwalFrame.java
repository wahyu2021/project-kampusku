 ...
 * @author ACER
 */
public class AddJadwalFrame extends javax.swing.JFrame {
    /**
     * Creates new form EditJadwalFrame
     */
    
    public AddJadwalFrame() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel2.add(btnTambah, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 240, 122, 30));
    ...
    private boolean ambilDataForm() {
        ...
        return jadwalDAO.addJadwal(jadwal);
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddJadwalFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

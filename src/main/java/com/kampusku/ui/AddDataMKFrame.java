 ...
 * @author ACER
 */
public class AddDataMKFrame extends javax.swing.JFrame {

    /**
     * Creates new form EditJadwalFrame
     */
    public AddDataMKFrame() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("TAMBAH DATA MK");
    ...
    private boolean ambilDataForm() {
        ...
        int kodeMK = Integer.parseInt(kodeMKField.getText());  // Assuming kodeMKField is a JTextField
        String namaMK = namaMKField.getText();  // Assuming namaMKField is a JTextField

        // Get the selected value from the JSpinner (assuming jmlSks is the JSpinner)
        int sks = (int) jmlSks.getValue();
        
        MataKuliah mataKuliah = new MataKuliah(kodeMK, namaMK, sks);
        MataKuliahDAO mkDAO = new MataKuliahDAO();
        return mkDAO.addMataKuliah(mataKuliah);
    }

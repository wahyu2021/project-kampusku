 ...
 * @author ACER
 */
public class DataMhsFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        rbNim = new javax.swing.JRadioButton();
        ...
        navDataMhs.setForeground(new java.awt.Color(255, 255, 255));
        ...
        tableDataMhs.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "NIM", "Kelas", "Nama", "Email", "Jenis Kelamin", "Nomor Telepon"
            }
        ));
        ...
        jLabel3.setText("NIM");
        main.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 410, -1, 12));
        main.add(NIMField, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 430, 181, -1));

        btnHapus.setBackground(new java.awt.Color(220, 76, 100));
        btnHapus.setFont(new java.awt.Font("Poppins Medium", 0, 12)); // NOI18N
        btnHapus.setForeground(new java.awt.Color(255, 255, 255));
        btnHapus.setText("Hapus Mahasiswa");
        btnHapus.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnHapusActionPerformed(evt);
            }
        });
        main.add(btnHapus, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 470, -1, -1));

        btnEdit.setBackground(new java.awt.Color(228, 161, 27));
        ...
        main.add(btnEdit, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 470, -1, -1));

        btnTambah.setBackground(new java.awt.Color(59, 113, 202));
        ...
        main.add(btnTambah, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 20, -1, -1));
        main.add(jOptionPane, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 200, -1, -1));

        rbKelas.setFont(new java.awt.Font("Poppins Medium", 0, 12)); // NOI18N
        rbKelas.setForeground(new java.awt.Color(51, 51, 51));
        rbKelas.setText("Kelas");
        main.add(rbKelas, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 60, -1, -1));

        rbNim.setFont(new java.awt.Font("Poppins Medium", 0, 12)); // NOI18N
        rbNim.setForeground(new java.awt.Color(51, 51, 51));
        rbNim.setText("NIM");
        main.add(rbNim, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 60, -1, -1));

        rbNama.setFont(new java.awt.Font("Poppins Medium", 0, 12)); // NOI18N
        rbNama.setForeground(new java.awt.Color(51, 51, 51));
        rbNama.setText("Nama");
        main.add(rbNama, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 60, -1, -1));
    ...
    private void loadDataMhs() {
        ...
        List<Mahasiswa> jadwalList = mahasiswaDAO.getAllMahasiswa();
    ...
    private void handleSearch() {
        ...
        List<Mahasiswa> results = null;
        
        // Memilih metode pencarian berdasarkan radio button yang dipilih
        if (rbNim.isSelected()) {
            results = getMahasiswaByNIM(keyword);
        } else if (rbKelas.isSelected()) {
            results = getMahasiswaByNama(keyword);
        } else if (rbKelas.isSelected()) {
            results = getMahasiswaBykelas(keyword);
        }else {
    ...
    private void updateTableData(List<Mahasiswa> mahasiswaList) {
        ...
        for (Mahasiswa mahasiswa : mahasiswaList) {
            model.addRow(new Object[]{
                mahasiswa.getNIM(),
                mahasiswa.getNamaKelas(),
                mahasiswa.getNamaMhs(),
                mahasiswa.getEmail(),
                mahasiswa.getJenisKelamin(),
                mahasiswa.getNoTelepon()
            });
        }
    }

    // metode pencarian berdasarkan filter
    private List<Mahasiswa> getMahasiswaByNIM(String NIM) {
        MahasiswaDAO mahasiswaDAO = new MahasiswaDAO();
        return mahasiswaDAO.getMahasiswaByNIM(NIM);
    }
    
    private List<Mahasiswa> getMahasiswaByNama(String nama) {
        MahasiswaDAO mahasiswaDAO = new MahasiswaDAO();
        return mahasiswaDAO.getMahasiswaByNama(nama);
    }
    
    private List<Mahasiswa> getMahasiswaBykelas(String kelas) {
        MahasiswaDAO mahasiswaDAO = new MahasiswaDAO();
        return mahasiswaDAO.getAllMahasiswaByClass(kelas);
    }
    ...
    private void btnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHapusActionPerformed
        ...
        if(!mahasiswaDAO.isMahasiswaExist(NIM)){
            jOptionPane.showMessageDialog(null, "Mahasiswa tidak ada", "Error", jOptionPane.ERROR_MESSAGE);
            return;
        }
        
        try {
            // Menghapus data menggunakan DAO
            ...
            if (mahasiswaDAO.deleteMahasiswa(NIM)) {
                ...
                loadDataMhs(); // Memuat ulang data setelah penghapusan
            } else {
    ...
    private void btnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditActionPerformed
        ...
        new EditDataMhsFrame(NIM).setVisible(true);
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DataMhsFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JRadioButton rbNim;
